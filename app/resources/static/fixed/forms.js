...
function make_form_expandable(expandedSectionSelector) {
  var expandedSection = document.querySelector(expandedSectionSelector);
  if (expandedSection == null) {
    return;
  }
  var expandedPart = expandedSection.querySelector('div.expanded-part');
  var expandButton = expandedSection.querySelector('a.expand-button');

  expandedPart.style.display = 'none';
  expandButton.addEventListener('click', function() {
    if (expandedPart.style.display == 'block') {
      expandedPart.style.display = 'none';
      expandButton.classList.remove('expand-button-icon-up');
      expandButton.classList.add('expand-button-icon-down');
    } else {
      expandedPart.style.display = 'block';
      expandButton.classList.remove('expand-button-icon-down');
      expandButton.classList.add('expand-button-icon-up');
    }
  });
}
