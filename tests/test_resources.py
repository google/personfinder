...
class ResourcesTests(unittest.TestCase):
    def setUp(self):
        ...
        self.temp_entities = [resources.Resource(
            key_name='page:fr', title='page',
            content='fran\xc3\xa7ais', content_type='text/html',
            template_name='template', cache_seconds=20
        ), resources.Resource(
            key_name='page', title='page',
            content='default', content_type='text/html',
            template_name='template', cache_seconds=30
        ), resources.Resource(
            key_name='template:es', title='template',
            content='\xc2\xa1hola! {{content|safe}}', content_type='text/html',
            cache_seconds=40
        ), resources.Resource(
            key_name='template:en', title='template',
            content='hi! {{content|safe}}', content_type='text/html',
            cache_seconds=50
        ), resources.Resource(
            key_name='data', title='data',
            content='\xff\xfe\xfd\xfc', content_type='application/data'
        )]
